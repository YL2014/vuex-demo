<template>
	<div class="product-detail-view" v-show="productDetail">
		<header>
		...
		<div class="detail">
			...
			<div>
				...
				<p>{{detail.plantYear}}年树</p>
				<p>{{detail.stock_quantity}}/{{detail.sale_number}}棵</p>
				<p><span>￥{{detail.sell_price}}</span><span>元/棵</span></p>
		...
		<div class="detail-info">
			<p>商品详情</p>
			<div class="img-cont">
				<img src="/static/img/rengou/01.jpg">
				<img src="/static/img/rengou/02.jpg">
				<img src="/static/img/rengou/03.jpg">
				<img src="/static/img/rengou/04.jpg">
				<img src="/static/img/rengou/05.jpg">
				<img src="/static/img/rengou/06.jpg">
				<img src="/static/img/rengou/07.jpg">
				<img src="/static/img/rengou/08.jpg">
				<img src="/static/img/rengou/09.jpg">
				<img src="/static/img/rengou/10.jpg">
				<img src="/static/img/rengou/11.jpg">
				<img src="/static/img/rengou/12.jpg">
				<img src="/static/img/rengou/13.jpg">
				<img src="/static/img/rengou/14.jpg">
				<img src="/static/img/rengou/15.jpg">
			</div>
		</div>
...
export default {
	...
	route: {
		data ({to}) {
			if(this.productInfo.lists.length == 0){
				this.productDetail = false
				to.router.go({path: '/app/home'})
			}else{
				let id = to.params.id
				this.productDetail = true
				this.productInfo.lists.forEach((item, index) => {
					if(item.id == id){
						this.detail = item
					}
				})
	...
	methods: {
		buy () {
			window.location.href = 'http://weidian.com/item.html?itemID=1835992814'
		}
	}
}
</script>
